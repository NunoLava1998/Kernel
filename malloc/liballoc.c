...
// This is liballoc, a memory allocator designed to be plugged into kernels such as these.
// This code has NOT been modified in any way, not even the comments, except for the printf() functions which are not supported by the kernel (yet).
